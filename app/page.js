  ...
  return (
    <main className="background pb-20">
      <section className=" xl:flex xl:flex-col xl:flex-wrap pt-10 mx-5 px-6 md:mx-auto md:w-4/12 xl:ms-56 xl:ps-0 xl:pe-0  xl:mx-0">
        <h2 className="text-center text-Neutral-600 text-base font-semibold tracking-24% xl:text-start xl:text-xl">EXPLORE THE</h2>
        ...
        <p className="text-center text-Neutral-600 text-base mt-6 font-semibold xl:text-start xl:text-xl">Here you’ll be able to redeem all of your hard-earned Aeropoints and exchange them for cool tech.</p>
